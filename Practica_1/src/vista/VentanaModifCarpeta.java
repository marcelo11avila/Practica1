 ...
 * @author EstebanRM
 */
public class VentanaModifCarpeta extends JFrame{
    ...
    public void iniciaComponentes()
    {
        ...
        this.etiList.add(new JLabel("Carpeta Destino de la carpeta a modificarse"));
        this.etiList.add(new JLabel("Modificar Carpeta: Ingrese el nuevo nombre"));
        ...
        this.boton1.addActionListener(new EventoVentanaModifCarpeta(this));
        this.boton2.addActionListener(new EventoVentanaModifCarpeta(this));
